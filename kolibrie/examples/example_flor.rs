...
/*
 * Dag Pieter
    Ik heb 3 datasets gegenereerd.
    En per window meet ik query_execute tijd and herplan tijd:
    Dus dan heb ik per run al meerdere waarderen, dus daar ook geen gemiddelde van nemen of wel blabla
 */